...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Se debe crear una funciòn que especifique lo que va a suceder cuando el usuario de click
    ...
    //Utilizando FindViewById, en este caso se asignan a los datos que pertenecen
    private fun bind(){
    ...
    //creating function to calculate and display BMI= Weight/(Height)2
    ...
    //Se deben definir los rangos en los cuales se va a ubicar las personas con los datos que ingrese
